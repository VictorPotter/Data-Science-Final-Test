...
--DROP TABLE public."PROPOSITO" CASCADE;
--DROP TABLE public."PROFISSAO" CASCADE;
--DROP TABLE public."OUTROSFINANC" CASCADE;
--DROP TABLE public."INVESTIMENTOS" CASCADE;
--DROP TABLE public."HISTORICO_CREDITO" CASCADE;
--DROP TABLE public."HABITACAO" CASCADE;
--DROP TABLE public."FIADOR" CASCADE;
--DROP TABLE public."ESTADOCIVIL" CASCADE;
--DROP TABLE public."EMPREGO" CASCADE;
--DROP TABLE public."CREDITO" CASCADE;
--DROP TABLE public."CLIENTES" CASCADE;
--DROP SEQUENCE public.idcliente CASCADE;
